...
<body>
		...
		<div class="sidenav">
		<h2 style="font-family:Arial; color:white; text-align:center;"> E-Commerce Medical Website </h2>
			<p style="margin-top:-20px;color:white;line-height:1;font-size:12px;text-align:center">Guidance: Mr.Pawan Malani sir <br>and Mrs.Jayashree Kunde  </p>
	...
	while($row = $result->fetch_assoc()) {
		...
		//adding purchase details from database by using ftech_assoc()
		while($row1 = $result1->fetch_assoc()) {
			...
			echo "<tr>";
				...
				//as the button click we will get the pid and it will be jumped to update.php form
				echo "<a class='button1 del-btn' href=purchase-delete.php?pid=".$row['p_id']."&sid=".$row['sup_id']."&mid=".$row['med_id'].">Delete</a>";
								//as the button click we will get the pid and it will be jumped to purchase_delete.php form
				echo "</td>";
			echo "</tr>";
		}
	}
